...
public class ReporteDeCreditoConFicoScoreApi {
    ...
    public okhttp3.Call getScoresAsync(String folioConsulta, String xApiKey, final ApiCallback<Scores> callback) throws ApiException {
        ProgressResponseBody.ProgressListener progressListener = null;
        ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
        if (callback != null) {
            progressListener = new ProgressResponseBody.ProgressListener() {
        ...
        okhttp3.Call call = getScoresValidateBeforeCall(folioConsulta, xApiKey, progressListener, progressRequestListener);
